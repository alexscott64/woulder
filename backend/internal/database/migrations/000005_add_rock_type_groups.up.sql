-- NOTE: production bootstrapped before this migration was authored; the live
-- DB has this table's column named `group_name`, not `name`. Migration 000034
-- converges fresh bootstraps to match. Do not edit this file retroactively.
